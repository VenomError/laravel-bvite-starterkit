            ...
            <div class="offcanvas-body flex-column custom_scroll" style="background: var(--body-color);">
                <ul class="nav nav-tabs tab-card justify-content-between px-0" role="tablist">
                    <li class="nav-item" role="presentation"><button class="nav-link pt-0 active" data-bs-toggle="pill"
                            data-bs-target="#pills_today" type="button" role="tab">Today</button></li>
                    <li class="nav-item" role="presentation"><button class="nav-link pt-0" data-bs-toggle="pill"
                            data-bs-target="#pills_wallet" type="button" role="tab">Wallet</button></li>
                    <li class="nav-item" role="presentation"><button class="nav-link pt-0" data-bs-toggle="pill"
                            data-bs-target="#pills_tasks" type="button" role="tab">Tasks</button></li>
                    <li class="nav-item" role="presentation"><button class="nav-link pt-0" data-bs-toggle="pill"
                            data-bs-target="#pills_emails" type="button" role="tab">Emails</button></li>
                </ul>
                <div class="tab-content mt-3">
                                ...
                                <div class="card border-0">
                                    ...
                                    <div class="card-body avatar-list avatar-list-stacked ps-4">
                                        <img class="avatar rounded-circle" src="assets/images/xs/avatar1.jpg"
                                            data-bs-toggle="tooltip" aria-label="Avatar" data-bs-title="Avatar"
                                            alt="avatar">
                            ...
                            <li class="col-12">
                                <div class="card border-0">
                                    ...
                                    <div class="card-body d-flex align-items-start">
                                        <div class="avatar rounded-circle no-thumbnail theme-color2 text-white">
                                        ...
                                        <div class="flex-fill ms-3">
                                            <h6 class="mb-4">Best of trendy design in <a href="#">2022</a> on
                                                Awwwards</h6>
                        ...
                        <ul class="row g-4 list-unstyled li_animate mb-0 trending-blog">
                            ...
                            <li class="col-12 d-flex align-items-start">
                                ...
                                <div class="text-truncate ms-2 ps-3 border-start dashed border-0">
                                    ...
                                    <h6 class="text-truncate"><a href="blog-detail.html" title="blog title"
                                            class="text-body">Unleashing the Power of
                                            ChatGPT</a></h6>
                            ...
                            <li class="col-12 d-flex align-items-start">
                                ...
                                <div class="text-truncate ms-2 ps-3 border-start dashed border-0">
                                    ...
                                    <h6 class="text-truncate"><a href="blog-detail.html" title="blog title"
                                            class="text-body">Designing for the Web</a>
                                    </h6>
                                    <div class="d-flex align-items-center text-muted small">
                                        <span class="pe-3">Feb 20</span>
                            ...
                            <li class="col-12 d-flex align-items-start">
                                ...
                                <div class="text-truncate ms-2 ps-3 border-start dashed border-0">
                                    ...
                                    <h6 class="text-truncate"><a href="blog-detail.html" title="blog title"
                                            class="text-body">Building Dynamic User
                    ...
                    <div class="tab-pane fade" id="pills_wallet" role="tabpanel">
                        <ul class="row g-1 list-unstyled li_animate">
                            ...
                            <li class="col-4">
                                <a href="#" class="card border-0 text-center small text-decoration-none"
                                    aria-label="Cards">
                                    <div class="card-body px-2">
                                        <svg class="svg-stroke mb-2" xmlns="http://www.w3.org/2000/svg"
                                            width="30" height="30" viewBox="0 0 24 24" stroke="currentColor"
                                            fill="none" stroke-linecap="round" stroke-linejoin="round">
                            ...
                            <li class="col-12">
                                <div class="card border-0">
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <a href="#" title="view all task" class="btn btn-dark w-100">View My
                                            Task</a>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li class="col-12">
                                <ul class="list-group">
                                    <li class="list-group-item d-flex align-items-center border-0 mb-1">
                                        <img class="rounded-circle avatar sm" src="assets/images/xs/avatar1.jpg"
                                    ...
                                    <li class="list-group-item d-flex align-items-center border-0 mb-1">
                                        <img class="rounded-circle avatar sm" src="assets/images/xs/avatar2.jpg"
                                            data-bs-toggle="tooltip" title="Avatar Name" alt="Avatar">
                                        <div class="ms-3 w-100">
                                    ...
                                    <li class="list-group-item d-flex align-items-center border-0 mb-1">
                                        <img class="rounded-circle avatar sm" src="assets/images/xs/avatar3.jpg"
                                            data-bs-toggle="tooltip" title="Avatar Name" alt="Avatar">
                                        <div class="ms-3 w-100">
                                    ...
                                    <li class="list-group-item d-flex align-items-center border-0 mb-1">
                                        <img class="rounded-circle avatar sm" src="assets/images/xs/avatar4.jpg"
                                            data-bs-toggle="tooltip" title="Avatar Name" alt="Avatar">
                                        <div class="ms-3 w-100">
                                            <a href="#" title="Github">Github</a>
